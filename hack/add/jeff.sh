...
END-MAIN
BEGIN-ISSUES
{"ruleset":"ruleSet-1", "rule":"rule-1","name":"Rule-1.1-Violated","category":"warning","effort":10}
{"ruleset":"ruleSet-2", "rule":"rule-1","name":"Rule-1.1-Violated","category":"warning","effort":10}
{"ruleset":"ruleSet-3", "rule":"rule-1","name":"Rule-1.1-Violated","category":"warning","effort":10}
END-ISSUES
BEGIN-DEPS
END-DEPS
EOF
